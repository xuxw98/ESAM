...
class TRScanData(object):
    ...
    def __init__(self, root_path, split='train', save_path=None):
        ...
        self.sample_id_list = [str(i).zfill(3) for i in range(46)]
    ...
    def get_aligned_box_label(self, idx):
        box_file = osp.join(self.root_dir, '3rscan_instance_data',
    ...
    def get_axis_align_matrix(self, idx):
        matrix_file = osp.join(self.root_dir, '3rscan_instance_data',
    ...
    def get_infos(self, num_workers=4, has_label=True, sample_id_list=None):
        ...
        def process_single_scene(sample_idx):
            ...
            pts_filename = osp.join(self.root_dir, '3rscan_instance_data',
            ...
            sp_filename = osp.join(self.root_dir, '3rscan_instance_data',
            ...
            if not self.test_mode:
                pts_instance_mask_path = osp.join(
                    self.root_dir, '3rscan_instance_data',
...
class TRScanMVData(object):
    ...
    def __init__(self, root_path, split='train'):
        ...
        self.split_dir = osp.join(root_path)
        # 16 25 
        self.sample_id_list = [str(i).zfill(3) for i in list(range(16))+list(range(17,25))+list(range(26,46))]
        self.test_mode = (split == 'test')
