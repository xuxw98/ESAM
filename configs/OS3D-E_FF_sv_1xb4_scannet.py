...
data_root = 'data/scannet-sv_fast/'
data_prefix = dict(
    pts='points',
...
train_pipeline = [
    ...
    dict(
        type='Pack3DDetInputs_FF',
        keys=[
            'points', 'gt_labels_3d', 'pts_semantic_mask', 'pts_instance_mask',
            'sp_pts_mask', 'gt_sp_masks', 'elastic_coords', 'img_path',
        ],
...
test_pipeline = [
    ...
    dict(type='Pack3DDetInputs_FF', keys=['points', 'sp_pts_mask', 'img_path',],
        dataset_type='scannet')
]
